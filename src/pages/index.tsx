...
export default function HomePage() {
  return (
    <MainLayout>
      <Seo />
      <section className='relative left-0 right-0 top-0 flex min-h-screen items-center justify-center bg-gradient-to-b from-custom-purple via-violet-500 to-white dark:via-purple-950 dark:to-black'>
        <BgParticles />
        <div className='text-center text-white'>
          <h1 className='font-airstrike text-6xl md:text-8xl lg:text-9xl'>
            MAGE 9
          </h1>
          <h1 className='font-lexend text-xl font-bold  md:text-3xl'>
            Multimedia and Game Event
          </h1>
          <h2 className='mt-12 whitespace-nowrap text-xl font-bold drop-shadow md:text-4xl'>
      ...
      <section
        className={merge(
          'relative z-20 flex min-h-screen items-center justify-center gap-10 p-10 max-lg:flex-col',
          ' bg-white dark:bg-black'
        )}
      >
        <div className='w-3/4 text-center md:text-justify'>
          <h1 className=' mb-2 text-4xl font-bold sm:text-5xl md:mb-8 md:text-6xl lg:text-7xl'>
            About <br /> Mage
          </h1>
          <div className='mx-auto mb-2 h-2 w-[70%] bg-custom-purple  md:mx-1 md:mb-8 md:h-3 md:w-[50%]'></div>
        ...
        <div className=' grid grid-cols-2 gap-5'>
          <Image
            ...
            height={1000}
            alt='about-1'
            className='col-span-2 mx-auto h-auto w-[100%]'
          />
          <Image
      ...
      {/* MASCOT MAGE */}
      <section className='relative z-40 flex min-h-screen flex-col items-center justify-start bg-gradient-to-b from-white to-custom-green dark:from-black dark:to-custom-blue'>
        <div className='container mx-auto mt-10'>
          ...
          />
          <div className='mx-auto -mt-14 w-80 rounded-full bg-custom-purple'>
          ...
          <h1 className='mx-5 py-2 text-center text-sm sm:mx-auto md:max-w-5xl md:text-lg lg:text-xl'>
            T.y.o merupakan seekor kucing dari masa depan yang menyukai hal-hal
            yang berbau teknologi. Pada saat ia melakukan percobaan mesin waktu,
            ia membuat kesalahan yang membuatnya terlempar ke masa lalu. Dan
            kini ia tengah mengumpulkan orang orang berbakat untuk membantunya
      ...
      <section className='flex min-h-screen flex-col justify-center gap-10 bg-gradient-radial from-[#5B8FB9] from-[0%] to-custom-green to-[50%] text-black dark:from-[#5B8FB9] dark:to-custom-blue dark:text-white md:gap-24'>
        <RightCompetitionBanner
          gradient='from-[#87CBB9] to-[#569DAA] dark:from-[#3352C0] dark:to-custom-blue'
          title='ROBOTICS'
      ...
      <section className=' relative flex min-h-screen flex-col justify-center gap-10 bg-gradient-radial from-[#5B8FB9] from-[0%] to-custom-green to-[50%] pt-20 text-black dark:from-[#5B8FB9] dark:to-custom-blue dark:text-white md:gap-24'>
        <RightCompetitionBanner
        ...
        />
        <div className='h-24 min-w-[100vw] bg-gradient-to-b  from-custom-green to-white dark:from-custom-blue dark:to-[#03001C]'></div>
      </section>
      <div className='min-h-screen bg-gradient-to-b from-white to-custom-green dark:from-[#03001C] dark:to-custom-blue'>
          ...
          <div className='col-start-2 col-end-3'>
            <div className='flex flex-col items-center justify-center'>
              <p className='mb-2 text-justify text-xs md:mb-8 md:text-sm lg:text-lg'>
                ...
                pengunjung dapat mengunjungi semua pameran dari tiap tim cabang
                lomba apapun.
              </p>
            </div>
          </div>
      ...
      <div className='from-customto-custom-green dark:from-customto-custom-blue flex min-h-screen flex-col items-center justify-center bg-gradient-radial from-[0%] to-[#5B8FB9] to-[50%] py-10 dark:to-[#03001C]'>
          ...
          <div className='col-start-4 col-end-8 '>
            <div className='mx-2 md:mx-0'>
              <div className='grid grid-cols-3 gap-2 md:gap-8'>
                <div className='col-start-1 col-end-2 '>
                  <WorkshopImageCard title='MULTI' subtitle='MEDIA' image='1' />
                </div>
                <div className='col-start-2 col-end-3'>
      ...
      <div className='from-customto-custom-blue min-h-screen bg-gradient-to-b from-[10%] via-[#03001C] via-[10%] to-custom-blue to-[100%]'>
        <div className='from-customto-custom-green dark:from-customto-custom-blue flex min-h-screen flex-col items-center justify-center bg-gradient-radial from-[0%] to-[#5B8FB9] to-[50%] py-10 dark:to-[#03001C]'>
      ...
      <div className='flex min-h-screen flex-col items-center justify-center bg-gradient-to-b from-[#5B8FB9] to-custom-purple dark:from-[#03001C] dark:to-custom-purple'>
        <h1 className='pt-[10vh] text-center text-3xl font-extrabold tracking-wide text-white sm:text-4xl md:text-5xl lg:text-6xl'>
          OUR PARTNER
        </h1>
        <div className='from-customto-custom-green/30 mx-auto flex h-[70vh] min-w-[90vw] flex-col items-center justify-center rounded-[40px] bg-gradient-to-b to-transparent md:mt-10 md:min-w-[80vw]'>
      ...
      <Footer
        footerColor='bg-custom-purple dark:bg-custom-purple'
